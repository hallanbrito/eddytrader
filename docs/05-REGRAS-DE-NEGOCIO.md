...
* **Enunciado:** O operador deve ser mantido informado diretamente na tela do gráfico sobre o estado da proteção, o horário do servidor corrente e as métricas financeiras da conta, com controle adaptativo da densidade visual:
  ...
  5. **Semântica do Resultado no HUD:** Os modos Compacto e Minimizado exibem o resultado do ciclo ativo $W_n(t)=D(t)-B_n$. O modo Detalhado exibe separadamente $W_n$, $D$ e $B_n$. A atualização visual jamais zera ou altera a contabilidade diária $D$ nem modifica baseline, FSM ou persistência crítica.
* **Rastreabilidade:** [RF-009](file:///C:/Projetos/eddytrader/docs/03-REQUISITOS.md#rf-009), [RF-011](file:///C:/Projetos/eddytrader/docs/03-REQUISITOS.md#rf-011), [RF-014](file:///C:/Projetos/eddytrader/docs/03-REQUISITOS.md#rf-014), [RF-016](file:///C:/Projetos/eddytrader/docs/03-REQUISITOS.md#rf-016), [RNF-005](file:///C:/Projetos/eddytrader/docs/03-REQUISITOS.md#rnf-005).
