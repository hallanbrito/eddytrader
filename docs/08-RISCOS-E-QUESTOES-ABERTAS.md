...
| **GAP-007** | Proteção Monotônica de Stop Loss (SL Lock) | **ABERTO — INVESTIGAÇÃO W11** | Demanda comportamental de impedir afrouxamento ou remoção de Stop Loss pelo trader. **NÃO IMPLEMENTADO NA W10**. Autorizado como escopo de investigação técnica empírica para a Work Package W11 (spike técnico). A implementação em código fica estritamente condicionada aos resultados da W11. | [02-ESCOPO-E-LIMITES.md](file:///C:/Projetos/eddytrader/docs/02-ESCOPO-E-LIMITES.md) / [09-ROADMAP.md](file:///C:/Projetos/eddytrader/docs/09-ROADMAP.md) |
...
* **Status:** **ABERTO — INVESTIGAÇÃO W11**
...
* **Documentos Vinculados:** [02-ESCOPO-E-LIMITES.md](file:///C:/Projetos/eddytrader/docs/02-ESCOPO-E-LIMITES.md), [09-ROADMAP.md](file:///C:/Projetos/eddytrader/docs/09-ROADMAP.md).
